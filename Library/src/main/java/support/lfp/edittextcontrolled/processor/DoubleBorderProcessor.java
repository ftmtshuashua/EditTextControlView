 ...
 * </pre>
 */
public class DoubleBorderProcessor extends BorderProcessor<Double> {

    public DoubleBorderProcessor(Double min, Double max) {
        super(min, max);
    }
    ...
    @Override
    protected Double getValue(Editable text) {
        return getView().getDoubleValue();
    }
